export const faqData = {
    magnetrontgen: [
        {
            q: "Hur går en MR-undersökning till?",
        ...
        {
            q: "Kan jag göra MR om jag är gravid?",
            a: "MR anses generellt vara säkert under graviditeten, men berätta alltid för kliniken innan undersökningen."
        },
        {
        ...
        },
        {
            ...
            a: "Kliniken som tar emot din remiss kommer att kontakta dig, och tillsammans kommer ni överens om en tid som passar dig bäst."
        },
    ],

    halsokontroller: [
        {
            q: "Behöver jag fasta innan provtagning?",
            a: "Vissa tester kräver fasta i 10–12 timmar. Du får tydlig information när du beställer testet."
        },
        {
            q: "Hur länge gäller remissen?",
            a: "En remiss gäller normalt i 6 månader från beställningsdatum."
        },
        {
    ...
    betalning: [
        ...
        {
            q: "Får jag kvitto?",
            a: "Ja, kvitto/faktura skickas automatiskt till din e-post."
        },
        {
            q: "Är priserna fasta?",
            a: "Ja, våra priser är fasta och inga dolda avgifter tillkommer."
        }
    ],
    ...
    saFungerarDet: [
        ...
        },
        {
            ...
            a: "De flesta undersökningar genomförs inom 1–7 arbetsdagar."
        },
        {
            q: "Behöver jag remiss?",
            a: "Nej, du beställer tjänsten direkt utan remiss."
        }
    ]
};
