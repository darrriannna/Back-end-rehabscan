...
export default function TestProductPage() {
    ...
    return (
        <>
            <SEO
                title={`${test.title} med blodprov | RehabScan`}
                description={
                    test.metaDescription ||
                    `${test.title} med blodprov och analys av relevanta hälsomarkörer. Se vad som ingår, pris och hur provtagningen fungerar.`
                }
                canonical={`https://www.rehabscan.se/halsokontroll/${test.slug}`}
            />
